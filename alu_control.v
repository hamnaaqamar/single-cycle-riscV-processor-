...
wire [6:0] funct7_full = funct7;  // Full 7-bit funct7
...
always @(*) begin
    case(ALUOp)
        ...
        2'b10: begin // R-type
            case(funct3)
                3'b000: alu_control_sig = (funct7_full[5]) ? 4'b0110 : 4'b0010; // sub or add
                ...
                3'b101: alu_control_sig = (funct7_full[5]) ? 4'b1011 : 4'b1001; // srl or sra
